export const emojis = {
    ...
    [
        ...
        {id: 1, name: 'ellipse', shapeType: 'ellipse', att: [{ry: "40", rx:"40", cy:"50%", cx:"50%", fill:"#ffd70f", stroke:"#000", strokeWidth:"4"}]},
    ...
    [
        ...
        {id: 5, name: 'dots', shapeType: "ellipse", att: [{cx: "37", cy: "40", rx: "2.331", ry: "2.331"}, {cx: "63", cy: "40", rx: "2.331", ry: "2.331"}]},
        {id: 6, name: 'neutral', shapeType: "path", att: [{d: "M57,41c3.504,0,7.009,0,10.513,0c0.496,0,0.991,0,1.487,0c1.287,0,1.289-2,0-2c-3.504,0-7.009,0-10.513,0 c-0.496,0-0.991,0-1.487,0C55.713,39,55.711,41,57,41L57,41z"}, {d: "M31,41c3.504,0,7.009,0,10.513,0c0.496,0,0.991,0,1.487,0c1.287,0,1.289-2,0-2c-3.504,0-7.009,0-10.513,0 c-0.496,0-0.991,0-1.487,0C29.713,39,29.711,41,31,41L31,41z"}]},
        {id: 7, name: 'X', shapeType: 'line', att: [{fill: 'none', stroke: '#000000', strokeWidth: '2', strokeMiterlimit: '10', x1: "32.115", y1: "35.115", x2: "41.885", y2: "44.885"}, {fill: 'none', stroke: '#000000', strokeWidth: '2', strokeMiterlimit: '10', x1: "41.885", y1: "35.115", x2: "32.115", y2: "44.885"}, {fill: 'none', stroke: '#000000', strokeWidth: '2', strokeMiterlimit: '10', x1: "58.115", y1: "35.115", x2: "67.885", y2: "44.885"}, {fill: 'none', stroke: '#000000', strokeWidth: '2', strokeMiterlimit: '10', x1: "67.885", y1: "35.115", x2: "58.115", y2: "44.885"}]}
    ...
    [
        ...
        {id: 2, name: 'neutral', shapeType: 'path', att: [{d: "M30.694,68.071c11.278,0,22.556,0,33.834,0c1.592,0,3.185,0,4.777,0c2.574,0,2.578-4,0-4c-11.278,0-22.556,0-33.834,0 c-1.592,0-3.185,0-4.777,0C28.12,64.071,28.116,68.071,30.694,68.071L30.694,68.071z"}]},
        ...
        {id: 6, name: 'sad', shapeType: 'path', att: [{d: "M33.53,70.111c0.055-0.047,0.112-0.091,0.167-0.137c0.181-0.152-0.476,0.343-0.123,0.095 c0.105-0.073,0.206-0.152,0.31-0.227c0.679-0.487,1.391-0.928,2.119-1.337c2.401-1.349,5-2.287,7.689-2.874 c6.48-1.415,13.583-0.625,19.495,2.436c0.917,0.475,1.81,0.998,2.66,1.585c0.133,0.092,0.863,0.631,0.549,0.391 c-0.308-0.235-0.006-0.003,0.076,0.068c1.944,1.669,4.786-1.148,2.828-2.828c-3.345-2.872-7.853-4.642-12.107-5.546 c-7.479-1.59-15.467-0.674-22.289,2.822c-1.477,0.757-2.938,1.64-4.202,2.725C28.745,68.962,31.585,71.78,33.53,70.111 L33.53,70.111z"}]}
    ...
    [
        ...
        {id: 2, name: 'neutral', shapeType: 'path', att: [{d: "M57.262,30.45c3.351,0,6.702,0,10.054,0c0.474,0,0.948,0,1.422,0c1.287,0,1.289-2,0-2c-3.351,0-6.702,0-10.054,0 c-0.474,0-0.948,0-1.422,0C55.975,28.45,55.973,30.45,57.262,30.45L57.262,30.45z"}, {d: "M31.262,30.45c3.351,0,6.702,0,10.054,0c0.474,0,0.948,0,1.422,0c1.287,0,1.289-2,0-2c-3.351,0-6.702,0-10.054,0 c-0.474,0-0.948,0-1.422,0C29.975,28.45,29.973,30.45,31.262,30.45L31.262,30.45z"}]},
        {id: 3, name: 'rounded', shapeType: 'path', att: [{d: "M54.635,32.707c1.948-2.04,5.524-2.852,8.365-2.852c2.84,0,6.418,0.813,8.365,2.852 c0.891,0.933,2.304-0.483,1.414-1.414c-2.398-2.511-6.457-3.438-9.78-3.438c-3.323,0-7.381,0.927-9.78,3.438 C52.331,32.224,53.743,33.64,54.635,32.707L54.635,32.707z"}, {d: "M28.635,32.707c1.948-2.04,5.524-2.852,8.365-2.852c2.84,0,6.418,0.813,8.365,2.852 c0.891,0.933,2.304-0.483,1.414-1.414c-2.398-2.511-6.457-3.438-9.78-3.438c-3.323,0-7.381,0.927-9.78,3.438 C26.331,32.224,27.743,33.64,28.635,32.707L28.635,32.707z"}]},
        {id: 4, name: 'angry', shapeType: 'path', att: [{d: "M56.23,32.328c3.292-1.018,6.584-2.036,9.875-3.054c0.472-0.146,0.945-0.292,1.417-0.438 c1.226-0.379,0.703-2.31-0.532-1.929c-3.292,1.018-6.584,2.036-9.875,3.054c-0.472,0.146-0.945,0.292-1.417,0.438 C54.472,30.779,54.995,32.71,56.23,32.328L56.23,32.328z"}, {d: "M45.134,30.114c-3.292-1.018-6.584-2.036-9.875-3.054c-0.472-0.146-0.945-0.292-1.417-0.438 c-1.232-0.381-1.759,1.549-0.532,1.929c3.292,1.018,6.584,2.036,9.875,3.054c0.472,0.146,0.945,0.292,1.417,0.438 C45.835,32.424,46.362,30.494,45.134,30.114L45.134,30.114z"}]},
    ],
    moustache:
    [
        {id: 0, name: 'none', shapeType: 'none'},
        {id: 1, name: 'moustache', shapeType: 'path', att: [{d: "M20.985,53.166c0,0,13.087,5.196,22.313,2.074c9.226-3.121,8.829,5.057-0.627,4.819 C33.214,59.822,20.985,53.166,20.985,53.166z"}, {d: "M78.997,53.166c0,0-13.087,5.196-22.313,2.074c-9.226-3.121-8.829,5.057,0.627,4.819 C66.768,59.822,78.997,53.166,78.997,53.166z"}]}
    ],
    other:
    [
        {id: 0, name: 'none', shapeType: 'none'},
        ...
        {id: 2, name: 'tear', shapeType: 'path', att: [{fill: '#7FCAFF', stroke: '#000000', strokeWidth: '2', strokeMiterlimit: '10', d: "M30.209,62.309 c-2.773,0.131-4.607-2.296-4.733-4.937c-0.125-2.641,4.035-9.806,4.035-9.806s4.818,6.741,4.942,9.382 C34.579,59.588,32.981,62.177,30.209,62.309z"}]}
    ]
